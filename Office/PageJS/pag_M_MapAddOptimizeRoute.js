...
{	
	$('#pag_M_MapAddOptimizeRoute_map_Optimize_Value').css({'margin':'auto','background-color':' #09F','z-index':1});
...
function checkHideShow(action)
{
	...
	{		
		...
		$('#pag_M_MapAddOptimizeRoute_btn_Up_Value').removeClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Up_Value').addClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Up_Value').prop('disabled', false);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Update_Value').removeClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Update_Value').addClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Update_Value').prop('disabled', false);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Top_Value').removeClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Top_Value').addClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Top_Value').prop('disabled', false);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Down_Value').removeClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Down_Value').addClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Down_Value').prop('disabled', false);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Bottom_Value').removeClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Bottom_Value').addClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Bottom_Value').prop('disabled', false);
		
		$('#pag_M_MapAddOptimizeRoute_btn_PlanRoute_Value').removeClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_PlanRoute_Value').addClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_PlanRoute_Value').prop('disabled', false);
	}
	else if(action == "NO")
	{
		...
		$('#pag_M_MapAddOptimizeRoute_btn_Up_Value').removeClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Up_Value').addClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Up_Value').prop('disabled', true);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Update_Value').removeClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Update_Value').addClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Update_Value').prop('disabled', true);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Top_Value').removeClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Top_Value').addClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Top_Value').prop('disabled', true);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Down_Value').removeClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Down_Value').addClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Down_Value').prop('disabled', true);
		
		$('#pag_M_MapAddOptimizeRoute_btn_Bottom_Value').removeClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_Bottom_Value').addClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_Bottom_Value').prop('disabled', true);
		
		$('#pag_M_MapAddOptimizeRoute_btn_PlanRoute_Value').removeClass('Button');
		$('#pag_M_MapAddOptimizeRoute_btn_PlanRoute_Value').addClass('Button_Disable');
		$('#pag_M_MapAddOptimizeRoute_btn_PlanRoute_Value').prop('disabled', true);
	}
...
function impl_LoadRoute_OnClick()
{
	...
	$('#pag_M_MapAddOptimizeRoute_lay_DetailPnl').show();
	checkHideShow(tmp[1]);
